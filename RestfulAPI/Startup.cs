            ...
            services.AddControllers(setupAction =>
           {
             ...
             .ConfigureApiBehaviorOptions(setupAction => 
             {
                 setupAction.InvalidModelStateResponseFactory = context =>
                 {
                     ...
                     {
                        problemDetails.Type = "http://courselibrary.com/module/modelvalidationproblem";
                      ...
                      // if one of the arguments wasn't correctly found / couldn't be parsed we're dealing with null/unparseable input
